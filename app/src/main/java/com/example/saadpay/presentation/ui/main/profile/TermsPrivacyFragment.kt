...
6. Account Deletion
As this is an educational app, users may uninstall the app at any time. There is no formal delete account option, but all local data will be removed upon uninstall.
...
""".trimIndent()
        ...
        view.findViewById<TextView>(R.id.termsBody).text = termsText
    }
}
